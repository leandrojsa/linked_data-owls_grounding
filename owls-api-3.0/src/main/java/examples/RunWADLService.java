...
public class RunWADLService {
	...
	public static void main(String[] args) throws URISyntaxException, IOException, ExecutionException, InterruptedException {
		...
		//URI uri = new URI("http://localhost/owl_s/restful/FBUserResource.owl");
		URI uri = new URI("http://localhost/owl_s/services/1.2/split/temp_wadl.owls");
